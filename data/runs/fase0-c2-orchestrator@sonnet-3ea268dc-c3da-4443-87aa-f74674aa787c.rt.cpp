...
// Modo de shading de depuración, seleccionado por argumento de línea de comandos
enum ShadeMode { MODE_NORMAL, MODE_DISTANCE };
ShadeMode g_shadeMode = MODE_NORMAL;
...
int main(int argc, char *argv[]) {
	...
	// selecciona el modo de shading de depuración por argumento de línea de comandos
	if (argc > 1 && strcmp(argv[1], "distance") == 0)
		g_shadeMode = MODE_DISTANCE;
	else
		g_shadeMode = MODE_NORMAL;
