...
// Variable global para el modo de sombreado
static int shadeMode = 0; // 0 = normal, 1 = distance
...
Color shade(const Ray &r) {
	...
	if (shadeMode == 0) {
		// Modo normal: color = obj.c + n
		colorValue = obj.c + n;
	} else {
		// Modo distance: gris basado en distancia
...
int main(int argc, char *argv[]) {
	// Leer modo de sombreado del argumento de línea de comandos
	if (argc > 1) {
