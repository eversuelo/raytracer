...
Color shade(const Ray &r) {
	...
	// seleccionar modo por argumento de línea de comandos
	if (shade_mode[0] == 'n') {
		// modo normal: color = obj.c + n
		colorValue = obj.c + n;
	} else {
		// modo distance: gris = (t - 144.676098) / (304.110891 - 144.676098)
...
int main(int argc, char *argv[]) {
	...
	// leer modo del argumento de línea de comandos
	if (argc > 1) {
		shade_mode = argv[1];
	}
