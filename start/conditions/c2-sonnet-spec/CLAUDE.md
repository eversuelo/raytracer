# CLAUDE.md — aitl-raytracer-spec-sonnet (condición C2-sonnet-spec: sonnet planifica, haiku implementa)
...
| Campo | Valor |
|-------|-------|
| **Clave MCP canónica del proyecto** | `aitl-raytracer-spec-sonnet` |
| **Software (jerarquía MCP)** | `raytracer` |

**Regla para toda llamada al MCP `aitl-js`:** pasa `project: "aitl-raytracer-spec-sonnet"`.
